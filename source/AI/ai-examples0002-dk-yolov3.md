# 使用darknet训练自己的yolo模型

## 准备

### 搭建darknet开发环境

darknet的搭建可以参考这个文档，安装需求搭建[安装配置darknet环境](/AI/ai-basic0002-darknet.html)
...
![ai-examples0002-1](/images/AI/ai-examples0002-1.jpg)
...
#### 标注
如下图所示:
![ai-examples0002-2](/images/AI/ai-examples0002-2.jpg)
